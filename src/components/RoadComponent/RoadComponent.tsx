      ...
      function calcMovement() {
        ...
        if(mainState.state.speed) {
          if(mainState.state.keypress.left) {
            mainState.state.xpos += (Math.abs(mainState.state.turn) + 7 + (mainState.state.speed > mainState.state.car.maxSpeed / 4 ? (mainState.state.car.maxSpeed - (mainState.state.speed / 2)) : mainState.state.speed)) * 0.2;
            mainState.state.turn -= 1;
          }
        ...
        if(Math.abs(mainState.state.xpos) > 550) {
          mainState.state.speed *= 0.96;
        }
        
        mainState.state.xpos = clamp(mainState.state.xpos, -650, 650);
      }
