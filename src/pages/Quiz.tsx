...
const trafficQuestions: Question[] = [
  {
    ...
    options: [
      ...
      { text: "Slow down and keep moving if the road looks clear.", correct: false },
      { text: "Honk and drive through quickly.", correct: false },
      { text: "Ignore it if you're in a hurry.", correct: false }
    ],
    explanation: "Always come to a complete stop at a stop sign and check for traffic before proceeding."
  },
  {
    text: "What should you do when approaching a yellow traffic light?",
    options: [
      { text: "Speed up to make it through before it turns red.", correct: false },
      { text: "Slow down and prepare to stop if it's safe to do so.", correct: true },
      { text: "Stop immediately regardless of your position.", correct: false },
      { text: "Honk to alert other drivers you're going through.", correct: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Continue at your current speed - pedestrians should wait for cars.", correct: false },
      { text: "Stop and yield to the pedestrian until they've crossed.", correct: true },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Drive at any speed as long as there are no children visible.", correct: false },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Pull over to the right side of the road and stop.", correct: true },
...
const Quiz: React.FC = () => {
  ...
  const handleAnswerQuestion = (correct: boolean, question: Question) => {
    ...
    const matchedQuestion = trafficQuestions.find(q => q.text === question.text);
    if (matchedQuestion) {
            ...
            <Card glass>
              <div className="flex flex-col items-center text-center">
                ...
                {gameOver ? (
                  ...
                  <p className="text-muted-foreground mb-6">
                    Navigate through traffic and answer questions about road safety!
                  </p>
                )}
